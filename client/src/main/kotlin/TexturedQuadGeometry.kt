...
class TexturedQuadGeometry(val gl : WebGL2RenderingContext, val repeatTextureX: Int = 1, val repeatTextureY: Int = 1) : Geometry() {
  ...
  init{
    ...
    gl.bufferData(GL.ARRAY_BUFFER,
      Float32Array( arrayOf<Float>(
         0.0f, repeatTextureY.toFloat(),
         0.0f,  0.0f,
        repeatTextureX.toFloat(), repeatTextureY.toFloat(),
        repeatTextureX.toFloat(),  0.0f
         )),
      GL.STATIC_DRAW)
  }    
